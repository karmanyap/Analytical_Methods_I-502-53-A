...
Exercise 4Using the command below, create a new dataframe called us12 that
...
nrow(US2005) 
inference(US2005$response, est = "proportion", type = "ci", method = "theoretical", success = "atheist")
