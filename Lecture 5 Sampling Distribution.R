...
mean(price_sample) #best point estimate
...
price_sample_150 <- sample(price,150)
mean(price_sample_150) #best point estimate
...
xlimits <- range(sample_means150) # limiting the values of the x axis
...
# Ans: The sample distribution with the larger sample size (150) has a smaller spread. When making estimates that 
# are more closer to the true value which is the mean, it is preferable and more accurate to choose smaller spreads.
